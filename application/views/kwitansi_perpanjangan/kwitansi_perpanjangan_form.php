    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('kwitansi_perpanjangan') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <?php echo form_open_multipart('kwitansi_perpanjangan/process') ?>
                 
                        <div class="form-group">
                            <label>Tanggal Invoice *</label>
                            <input type="hidden" name="id" value="<?= $row->kwitansi_perpanjangan_id ?>">
                            <input type="date" name="tanggal_kwitansi" value="<?= $row->tanggal_kwitansi ?>" class="form-control" required>
                        </div>
                        <div class="form-group ">
                            <label>Nomor Kwitansi *</label>
                            <input type="text" name="kode_kwitansi_perpanjangan" value="<?= $row->kode_kwitansi_perpanjangan ?>" class="form-control" readonly>
                        </div>
                        <div class="form-group">
