...
<head>
    <meta charset="utf-8" />
    <title>Hayo mau apa ??</title>
    <link rel="icon" href="http://sda.pu.go.id/balai/bbwspemalijuana/assets/pu_logo.png" type="image/x-icon">
    ...
    <link href="http://sda.pu.go.id/balai/bbwspemalijuana/assets/plugins/font-awesome/5.0/css/fontawesome-all.min.css" rel="stylesheet" />
    ...
    <div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    <span><img src="http://sda.pu.go.id/balai/bbwspemalijuana/assets/pu_logo.png" width="50px" height="50px"></span> <b>Login Cpanel</b>
