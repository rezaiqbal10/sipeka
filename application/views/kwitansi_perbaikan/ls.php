...
<div style="font-size : 20px">  KWITANSI/BUKTI PEMBAYARAN PERBAIKAN KENDARAAN DINAS</div>

</div>
<div style="margin-left: 200px">
<div style="font-size : 18px"> <?php foreach($row->result() as $key => $data) { ?>
    <span><?= $data->kode_kwitansi_perbaikan ?></span>
<?php
}
?>
</div>
                ...
                <tbody> 
                        <?php $no = 1;
                            ...
                            <tr>
                                ...
                                <td>PPK Ketatalaksanaan Satker BBWS Pemali Juana</td>    
                            </tr>
                            <tr>
