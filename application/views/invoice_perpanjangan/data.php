    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('invoice_perpanjangan/add') ?>" class="btn btn-primary btn-flat">
                    ...
                    foreach ($row->result() as $key => $data) { ?>
                        <tr><td><?= $no++; ?></td>
                            ...
                            <td class="text-center" width="200x">
                                 <a href="<?= site_url('invoice_perpanjangan/delete/' . $data->invoice_perpanjangan_id) ?>" id="btn-hapus" class="btn btn-danger btn-xs">
                                    <i class="fa fa-trash"> Hapus</i>
                                </a>
                                <a href="<?= site_url('invoice_perpanjangan/edit/' . $data->invoice_perpanjangan_id) ?>" class="btn btn-primary btn-xs">
